...
class models_filters_CommentsFilter extends models_filters_BaseFilter
{

    public function __construct()
    {
        // возможные значения фильтра сортировки
        $this->sortKeys = array('t1.answer ASC,t1.date_add','t1.date_add','id','comment','phonr','author');
