...
/** This file is part of KCFinder project
  *
  *      @desc This file is included first, before each additional
  *   @package KCFinder
  *   @version 3.12
  ...
  * which will be executed before any additional. Suitable for:
...
class SessionSaveHandler {
    ...
    // Return values from additional handlers are converted to boolean expression.
