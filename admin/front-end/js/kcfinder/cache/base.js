...
(function (wind, $, undef) {
     ...
     * @param ... All additional parameters are passed to jQuery's function
    ...
    var allowStyling = true,  // False if IE6 or additional unsupported browsers
            ...
            },
            {
                ...
                apply: function ($el, options) {
                    ...
                    if (isMsie()) {
                        ...
                        // All additional browsers behave properly
                        bindMany($el, options, {
