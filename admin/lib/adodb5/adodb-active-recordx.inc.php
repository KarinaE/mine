...
class ADODB_Active_Record {
	 ...
	 * these additional tables' rows may also be referenced by this table using theirname_id or the provided
	 * foreign keys (this index name is stored in ar->foreignKey)
	 *
	 * this-table.id = additional-table-#1.this-table_id
	 *               = additional-table-#2.this-table_id
	 */
...
# @todo Can I make this guy be lazy?
	 ...
	 * foreign keys (this index name is stored in ar->foreignKey)
	 *
	 * this-table.additional-table_id = additional-table.id
	 */
	...
	// I have an ON INSERT trigger on a table that sets additional columns in the table.
