...
/**
* parses an XML Schema, allows access to it's data, additional utility methods.
		...
		switch($name){
			...
			case 'complexType':
				...
				if(isset($attrs['name'])){
					...
					//       nested within additional c complexTypes?
...
/**
* parses a WSDL file, allows access to it's data, additional utility methods.
			...
			if ($pos_xml !== FALSE) {
				...
				if (preg_match("/encoding=[\"']([^\"']*)[\"']/", $xml_decl, $res)) {
					...
					if (strtoupper($xml_encoding) != $encoding) {
						...
						// when HTTP says ISO-8859-1 (the default) and XML says UTF-8 (the typical), assume the additional endpoint is just sloppy and proceed
					} else {
