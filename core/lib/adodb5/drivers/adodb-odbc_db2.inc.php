...
completely additional location, so the whole connection
was made over a slow network connection).

I hope this helps when additional encounter the same
...
> The symptom is that if I change the database engine from postgres or any additional to DB2 then the following
