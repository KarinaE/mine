...
class Google_Service_Fusiontables_Table_Resource extends Google_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   *
   * @opt_param bool replaceViewDefinition Whether the views definition is also
   * updated. The specified views definition replaces the existing one. Only a views
