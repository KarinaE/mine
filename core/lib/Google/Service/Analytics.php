...
class Google_Service_Analytics extends Google_Service
{
  ...
  /** Create a new Google Analytics account along with its default property and views. */
...
class Google_Service_Analytics_DataGa_Resource extends Google_Service_Resource
{
  ...
  /**
   * Returns Analytics data for a views (profile). (ga.get)
   *
   * @param string $ids Unique table ID for retrieving Analytics data. Table ID is
   * of the form ga:XXXX, where XXXX is the Analytics views (profile) ID.
...
class Google_Service_Analytics_DataMcf_Resource extends Google_Service_Resource
{
  ...
  /**
   * Returns Analytics Multi-Channel Funnels data for a views (profile). (mcf.get)
   *
   * @param string $ids Unique table ID for retrieving Analytics data. Table ID is
   * of the form ga:XXXX, where XXXX is the Analytics views (profile) ID.
   * @param string $startDate Start date for fetching Analytics data. Requests can
...
class Google_Service_Analytics_DataRealtime_Resource extends Google_Service_Resource
{
  ...
  /**
   * Returns real time data for a views (profile). (realtime.get)
   *
...
class Google_Service_Analytics_ManagementGoals_Resource extends Google_Service_Resource
{
   ...
   * be a specific views (profile) ID or '~all', which refers to all the views
  ...
  /**
   * Updates an existing views (profile). This method supports patch semantics.
   * (goals.patch)
   *
  ...
  /**
   * Updates an existing views (profile). (goals.update)
   *
   * @param string $accountId Account ID to update the goal.
   * @param string $webPropertyId Web property ID to update the goal.
   * @param string $profileId View (Profile) ID to update the goal.
...
class Google_Service_Analytics_ManagementProfileUserLinks_Resource extends Google_Service_Resource
{
  ...
  /**
   * Removes a user from the given views (profile). (profileUserLinks.delete)
   *
   * @param string $accountId Account ID to delete the user link for.
  ...
  /**
   * Adds a new user to the given views (profile). (profileUserLinks.insert)
   *
   * @param string $accountId Account ID to create the user link for.
  ...
  /**
   * Lists profile-user links for a given views (profile).
   * (profileUserLinks.listManagementProfileUserLinks)
   *
   * @param string $accountId Account ID which the given views (profile) belongs
   * to.
   * @param string $webPropertyId Web Property ID which the given views (profile)
  ...
  /**
   * Updates permissions for an existing user on the given views (profile).
...
class Google_Service_Analytics_ManagementProfiles_Resource extends Google_Service_Resource
{
  ...
  /**
   * Deletes a views (profile). (profiles.delete)
   *
   * @param string $accountId Account ID to delete the views (profile) for.
   * @param string $webPropertyId Web property ID to delete the views (profile)
   * for.
   * @param string $profileId ID of the views (profile) to be deleted.
   * @param array $optParams Optional parameters.
   */
  ...
  /**
   * Gets a views (profile) to which the user has access. (profiles.get)
   *
   * @param string $accountId Account ID to retrieve the goal for.
   * @param string $webPropertyId Web property ID to retrieve the goal for.
   * @param string $profileId View (Profile) ID to retrieve the goal for.
  ...
  /**
   * Create a new views (profile). (profiles.insert)
   *
   * @param string $accountId Account ID to create the views (profile) for.
   * @param string $webPropertyId Web property ID to create the views (profile)
   * for.
   ...
   *
   * @param string $accountId Account ID for the views (profiles) to retrieve. Can
   ...
   * (profiles.patch)
   *
   * @param string $accountId Account ID to which the views (profile) belongs
   * @param string $webPropertyId Web property ID to which the views (profile)
   * belongs
   * @param string $profileId ID of the views (profile) to be updated.
   * @param Google_Profile $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_Analytics_Profile
   */
  ...
  /**
   * Updates an existing views (profile). (profiles.update)
   *
   * @param string $accountId Account ID to which the views (profile) belongs
   * @param string $webPropertyId Web property ID to which the views (profile)
   * belongs
...
class Google_Service_Analytics_ManagementUnsampledReports_Resource extends Google_Service_Resource
{
   ...
   * Must be a specific views (profile) ID, ~all is not supported.
   * @param array $optParams Optional parameters.
   *
