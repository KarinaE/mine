...
class Google_Service_Resourceviews_ZoneViews_Resource extends Google_Service_Resource
{
  ...
  /**
   * Add resources to the views. (zoneViews.addResources)
   *
   * @param string $project The project name of the resource views.
   * @param string $zone The zone name of the resource views.
   * @param string $resourceView The name of the resource views.
  ...
  /**
   * Delete a resource views. (zoneViews.delete)
   *
   * @param string $project The project name of the resource views.
   * @param string $zone The zone name of the resource views.
   * @param string $resourceView The name of the resource views.
  ...
  /**
   * Get the information of a zonal resource views. (zoneViews.get)
   *
   * @param string $project The project name of the resource views.
   * @param string $zone The zone name of the resource views.
   * @param string $resourceView The name of the resource views.
  ...
  /**
   * Get the service information of a resource views or a resource.
  ...
  /**
   * Create a resource views. (zoneViews.insert)
   *
   * @param string $project The project name of the resource views.
   * @param string $zone The zone name of the resource views.
  ...
  /**
   * List the resources of the resource views. (zoneViews.listResources)
   *
   * @param string $project The project name of the resource views.
   * @param string $zone The zone name of the resource views.
   * @param string $resourceView The name of the resource views.
  ...
  /**
   * Remove resources from the views. (zoneViews.removeResources)
   *
   * @param string $project The project name of the resource views.
   * @param string $zone The zone name of the resource views.
   * @param string $resourceView The name of the resource views.
  ...
  /**
   * Update the service information of a resource views or a resource.
