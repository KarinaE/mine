...
class Google_Service_Fitness_UsersDataSources_Resource extends Google_Service_Resource
{
   ...
   * developer project number is obfuscated when read by any additional developer
   ...
   * sources that are only visible to additional developers or calls using additional
...
class Google_Service_Fitness_UsersSessions_Resource extends Google_Service_Resource
{
   ...
   * will not have any additional fields.
