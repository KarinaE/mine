...
class Google_Service_Prediction_Hostedmodels_Resource extends Google_Service_Resource
{
  ...
  /**
   * Submit input and request an output against a hosted models.
   * (hostedmodels.predict)
   *
   * @param string $project The project associated with the models.
   * @param string $hostedModelName The name of a hosted models.
...
class Google_Service_Prediction_Trainedmodels_Resource extends Google_Service_Resource
{
  ...
  /**
   * Get analysis of the models and the data the models was trained on.
   * (trainedmodels.analyze)
   *
   * @param string $project The project associated with the models.
   * @param string $id The unique name for the predictive models.
   * @param array $optParams Optional parameters.
  ...
  /**
   * Delete a trained models. (trainedmodels.delete)
   *
   * @param string $project The project associated with the models.
   * @param string $id The unique name for the predictive models.
   * @param array $optParams Optional parameters.
  ...
  /**
   * Check training status of your models. (trainedmodels.get)
   *
   * @param string $project The project associated with the models.
   * @param string $id The unique name for the predictive models.
   * @param array $optParams Optional parameters.
  ...
  /**
   * Train a Prediction API models. (trainedmodels.insert)
   *
   * @param string $project The project associated with the models.
  ...
  /**
   * Submit models id and request a prediction. (trainedmodels.predict)
   *
   * @param string $project The project associated with the models.
   * @param string $id The unique name for the predictive models.
   * @param Google_Input $postBody
  ...
  /**
   * Add new data to a trained models. (trainedmodels.update)
   *
   * @param string $project The project associated with the models.
   * @param string $id The unique name for the predictive models.
