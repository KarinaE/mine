...
class Google_Service_Drive_Files_Resource extends Google_Service_Resource
{
   ...
   * of downloading known malware or additional abusive files.
   ...
   * @opt_param bool updateViewedDate Whether to update the views date after
...
class Google_Service_Drive_Realtime_Resource extends Google_Service_Resource
{
  ...
  /**
   * Exports the contents of the Realtime API data models associated with this file
   * as JSON. (realtime.get)
   *
   * @param string $fileId The ID of the file that the Realtime API data models is
   * associated with.
   * @param array $optParams Optional parameters.
   *
   * @opt_param int revision The revision of the Realtime API data models to
   * export. Revisions start at 1 (the initial empty data models) and are
   * incremented with each change. If this parameter is excluded, the most recent
   * data models will be returned.
   */
  public function get($fileId, $optParams = array())
  {
    $params = array('fileId' => $fileId);
  ...
  /**
   * Overwrites the Realtime API data models associated with this file with the
   * provided JSON data models. (realtime.update)
   *
   * @param string $fileId The ID of the file that the Realtime API data models is
   * associated with.
   * @param array $optParams Optional parameters.
   *
   * @opt_param string baseRevision The revision of the models to diff the uploaded
   * models against. If set, the uploaded models is diffed against the provided
   * revision and those differences are merged with any changes made to the models
   * after the provided revision. If not set, the uploaded models replaces the
