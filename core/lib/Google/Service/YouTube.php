...
class Google_Service_YouTube_Activities_Resource extends Google_Service_Resource
{
   ...
   * additional API methods to generate those activity resources. For example, you
   ...
   * activity resource, the snippet property contains additional properties that
   ...
   * nextPageToken and prevPageToken properties identify additional pages that could be
   * retrieved.
...
class Google_Service_YouTube_ChannelSections_Resource extends Google_Service_Resource
{
   ...
   * channelSection resource, the snippet property contains additional properties, such
...
class Google_Service_YouTube_Channels_Resource extends Google_Service_Resource
{
   ...
   * resource, the contentDetails property contains additional properties, such as the
...
class Google_Service_YouTube_Search_Resource extends Google_Service_Resource
{
   ...
   * zh-Hant for traditional Chinese. Please note that results in additional languages
...
class Google_Service_YouTube_Subscriptions_Resource extends Google_Service_Resource
{
   ...
   * If the parameter identifies a property that contains child properties, the
   * child properties will be included in the response. For example, in a
   * subscription resource, the snippet property contains additional properties, such
