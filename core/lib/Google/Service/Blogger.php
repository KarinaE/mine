...
class Google_Service_Blogger_Blogs_Resource extends Google_Service_Resource
{
   ...
   * @opt_param string maxPosts Maximum number of posts to pull back with the
   * blog.
   * @opt_param string views Access level with which to views the blog. Note that
   ...
   * Live blogs only). Note that ADMIN access is required to views deleted blogs.
   ...
   * @opt_param string views Access level with which to views the blogs. Note that
   * some fields require elevated access.
...
class Google_Service_Blogger_Comments_Resource extends Google_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   *
   * @opt_param string views Access level for the requested comment (default:
   ...
   * included.
   * @opt_param string views Access level with which to views the returned result.
