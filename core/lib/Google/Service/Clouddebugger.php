  ...
  public function __construct(Google_Client $client)
  {
    ...
    $this->controller_debuggees = new Google_Service_Clouddebugger_ControllerDebuggees_Resource(
        ...
        array(
          'methods' => array(
            'register' => array(
              'path' => 'v2/controllers/debuggees/register',
              'httpMethod' => 'POST',
              'parameters' => array(),
            ),
          )
    ...
    $this->controller_debuggees_breakpoints = new Google_Service_Clouddebugger_ControllerDebuggeesBreakpoints_Resource(
        ...
        array(
          'methods' => array(
            'list' => array(
              'path' => 'v2/controllers/debuggees/{debuggeeId}/breakpoints',
              'httpMethod' => 'GET',
              'parameters' => array(
                'debuggeeId' => array(
                  'location' => 'path',
              ...
              'path' => 'v2/controllers/debuggees/{debuggeeId}/breakpoints/{id}',
              'httpMethod' => 'PUT',
              'parameters' => array(
                'debuggeeId' => array(
                  'location' => 'path',
...
/**
 * The "controllers" collection of methods.
 * Typical usage is:
 *  <code>
 *   $clouddebuggerService = new Google_Service_Clouddebugger(...);
 *   $controllers = $clouddebuggerService->controllers;
 *  </code>
 */
...
class Google_Service_Clouddebugger_ControllerDebuggees_Resource extends Google_Service_Resource
{
  ...
  /**
   * Registers the debuggee with the controllers. All agents should call this API
...
class Google_Service_Clouddebugger_ControllerDebuggeesBreakpoints_Resource extends Google_Service_Resource
{
   ...
   * should remember breakpoints that are complete until the controllers removes
   ...
   * protobuf must be sent back to the controllers. Updates to active breakpoint
